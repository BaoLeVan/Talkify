...
import com.talkify.common.ratelimit.RateLimit;
import com.talkify.common.ratelimit.RateLimitKey;
...
public class AuthController {
    ...
    @PostMapping("/login")
    @RateLimit(limit = 10, windowSeconds = 60, by = RateLimitKey.IP)
    ...
    @RateLimit(limit = 5, windowSeconds = 3600, by = RateLimitKey.IP)
    ...
    @RateLimit(limit = 30, windowSeconds = 60, by = RateLimitKey.IP)
    ...
    @RateLimit(limit = 5, windowSeconds = 600, by = RateLimitKey.USER)
    ...
    @RateLimit(limit = 3, windowSeconds = 600, by = RateLimitKey.USER)
