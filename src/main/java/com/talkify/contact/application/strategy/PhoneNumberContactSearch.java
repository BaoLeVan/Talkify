...
@Component
public class PhoneNumberContactSearch implements ContactSearchStrategy {
    private final ContactSearchRepository contactSearchRepository;

    public PhoneNumberContactSearch(ContactSearchRepository contactSearchRepository) {
        this.contactSearchRepository = contactSearchRepository;
    }

    @Override
    public Optional<Contact> search(String keyword) {
        return contactSearchRepository.searchByPhoneNumber(keyword);
    }
