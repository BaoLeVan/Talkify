...
@Component
public class EmailContactSearch implements ContactSearchStrategy {
    private final ContactSearchRepository contactSearchRepository;

    public EmailContactSearch(ContactSearchRepository contactSearchRepository) {
        this.contactSearchRepository = contactSearchRepository;
    }

    @Override
    public Optional<Contact> search(String keyword) {
        return contactSearchRepository.searchByEmail(keyword);
    }
}
