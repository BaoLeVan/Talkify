...
public class AuthController {
    ...
    public ApiResponse<Void> logout(HttpServletResponse response,
        ...
        // userId and sessionId come from the SecurityContext principal that was
        // populated by JwtAuthFilter after validating the access token.
        // /logout is no longer in PUBLIC_POST / SKIP_FILTER_PATHS, so the filter
        // always runs first — we never trust data supplied by the caller directly.
